...
describe("saveSettings", () => {
  ...
  test("formats JSON with 2-space indentation", () => {
    ...
    expect(fs.writeFileSync).toHaveBeenCalledWith(mockSettingsPath, expectedJson);
  });
});
...
describe("analyzeFields", () => {
  ...
  test("counts verified emails when either email or emailAddresses is present", () => {
    const users = [
      { userId: "1", email: "test1@example.com" },
      { userId: "2", emailAddresses: ["test2@example.com"] },
      { userId: "3", email: "test3@example.com", emailAddresses: ["test3@example.com"] },
    ];
  ...
  test("counts unverified emails correctly", () => {
    const users = [
      { userId: "1", email: "verified@example.com", unverifiedEmailAddresses: ["unverified@example.com"] },
  ...
  test("counts unverified phones correctly", () => {
    const users = [
      { userId: "1", phone: "+1234567890", unverifiedPhoneNumbers: ["+9999999999"] },
  ...
  test("identifies fields present on all users", () => {
    const users = [
      { userId: "1", firstName: "John", lastName: "Doe", email: "test@example.com" },
      { userId: "2", firstName: "Jane", lastName: "Smith", email: "test2@example.com" },
      { userId: "3", firstName: "Bob", lastName: "Johnson", email: "test3@example.com" },
    ];
  ...
  test("ignores empty string values in hasValue check", () => {
    const users = [
      { userId: "1", firstName: "", lastName: "Doe", email: "test@example.com" },
      { userId: "2", firstName: "Jane", lastName: "", email: "test2@example.com" },
    ];
...
describe("loadRawUsers", () => {
  ...
  test("loads and transforms JSON file with clerk handler", async () => {
    const mockJsonData = [
      {
        id: "user_123",
        first_name: "John",
  ...
  test("throws error when handler is not found", async () => {
    await expect(loadRawUsers("users.json", "invalid_handler")).rejects.toThrow(
      "Handler not found for key: invalid_handler",
    );
  });

  test("loads and transforms with supabase handler", async () => {
    const mockJsonData = [
      {
        id: "uuid-123",
        email: "john@example.com",
  ...
  test("loads and transforms with auth0 handler", async () => {
    const mockJsonData = [
      {
        _id: { $oid: "auth0123" },
        email: "john@example.com",
  ...
  test("loads and transforms with authjs handler", async () => {
    const mockJsonData = [
      {
        id: "1",
        email: "john@example.com",
